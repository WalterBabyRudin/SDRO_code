...
#######################################################
################# Data Loading ########################
data = sklearn.datasets.load_svmlight_file("data/housing_scale.txt")
...
# Dataloader_oracle = DataLoader(Dataset_tensor, batch_size=1000, shuffle=True)
...
Dataloader_all = DataLoader(Dataset_tensor, batch_size=10, shuffle=True)
...
if input_method == "SG":
    ...
    theta_SG, theta_SG_hist, cost_SG_hist = SDRO_optimizer.SDRO_SG_solver(Dataloader_all, theta0, SDRO_Reg, SDRO_Lambda, 
                        maxiter = 100, learning_rate = 5e-3, silence=True, K_sample_max=4, test_iterations = 10)
    ...
    np.save("results/obj_SG_hist_housing.npy", obj_SG_hist)
    np.save("results/residual_SG_hist_housing.npy", residual_SG_hist)
    np.save("results/cost_SG_hist_housing.npy", cost_SG_hist)
...
if input_method == "RTMLMC":
    theta_RTMLMC, theta_RTMLMC_hist, cost_RTMLMC_hist = SDRO_optimizer.SDRO_RTMLMC_solver(Dataloader_all, theta0, SDRO_Reg, SDRO_Lambda, 
                        maxiter = 100, learning_rate = 1e-2, silence=True, K_sample_max=4, test_iterations = 10)
    ...
    np.save("results/obj_RTMLMC_hist_housing.npy", obj_RTMLMC_hist)
    np.save("results/residual_RTMLMC_hist_housing.npy", residual_RTMLMC_hist)
    np.save("results/cost_RTMLMC_hist_housing.npy", cost_RTMLMC_hist)
...
if input_method == "MLMC":
    Dataloader_all = DataLoader(Dataset_tensor, batch_size=int(2**5), shuffle=True)
    theta_MLMC, theta_MLMC_hist, cost_MLMC_hist = SDRO_optimizer.SDRO_MLMC_solver(Dataloader_all, theta0, SDRO_Reg, SDRO_Lambda, 
                        maxiter = 100, learning_rate = 1e-2, silence=False, K_sample_max=4, test_iterations = 10)
    ...
    np.save("results/obj_MLMC_hist_housing.npy", obj_MLMC_hist)
    np.save("results/residual_MLMC_hist_housing.npy", residual_MLMC_hist)
    np.save("results/cost_MLMC_hist_housing.npy", cost_MLMC_hist)
...
if input_method == "RRMLMC":
    theta_RRMLMC, theta_RRMLMC_hist, cost_RRMLMC_hist = SDRO_optimizer.SDRO_RRMLMC_solver(Dataloader_all, theta0, SDRO_Reg, SDRO_Lambda, 
                        maxiter = 100, learning_rate = 4e-3, silence=False, test_iterations = 10)
    ...
    np.save("results/obj_RRMLMC_hist_housing.npy", obj_RRMLMC_hist)
    np.save("results/residual_RRMLMC_hist_housing.npy", residual_RRMLMC_hist)
    np.save("results/cost_RRMLMC_hist_housing.npy", cost_RRMLMC_hist)
...
if input_method == "RUMLMC":
    ...
    np.save("results/obj_RUMLMC_hist_housing.npy", obj_RUMLMC_hist)
    np.save("results/residual_RUMLMC_hist_housing.npy", residual_RUMLMC_hist)
    np.save("results/cost_RUMLMC_hist_housing.npy", cost_RUMLMC_hist)
